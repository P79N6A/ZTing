...
- (void)start:(UIButton  *)button{
    [AppDelegate shareAppDelegate].ztBaseBavCtrl = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"HomeNavViewController"];
    [self presentViewController:[AppDelegate shareAppDelegate].ztBaseBavCtrl animated:YES completion:^{
