...
@interface CountTableViewController ()<CYLTableViewPlaceHolderDelegate>

{
    NSMutableArray *_countData;
...
- (void)_loadData {
    ...
    [params setObject:@"3" forKey:@"pushType"];    // 消息类型(12进出场消息 3账户消息 4资产消息 5优惠消息)
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    msgDetailVC.msgModel = _countData[indexPath.row];
